	...
	<div class="col-xl-7 mx-auto">
		...
		<div class="card border-top border-0 border-4 border-danger">
			<div class="card-body p-5">
				...
				<hr>
				<form class="row g-3 was-validated"form action="{{ url('temporal/resizeTemporaryTablespace') }}" method="POST">
       				 @csrf
					<!--<div class="col-md-6">
                    ...
                    <div class="col-md-6">
						...
						<div class="input-group"> <span class="input-group-text bg-transparent"><i class="bx bxs-user"></i></span>
                             <input class="form-control " type="number" placeholder="25 Mega Bytes por defecto" id ="size" name="size"  required >
