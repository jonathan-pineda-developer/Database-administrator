        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title
                    ">Crear respaldo de una tabla de un schema</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="auditoria/columnOfATableOfASchema" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <label for="backuptable">Escoja el schema de la tabla al que quiere hacer un respaldo</label>
                        ...
                        <div class="form-group">
                            ...
                            <label for="backuptable">Ingrese el nombre de la tabla que quiere respaldar</label>
